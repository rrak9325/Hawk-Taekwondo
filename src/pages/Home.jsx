      ...
      <section className="py-12 lg:py-16 xl:py-20 bg-gradient-to-br from-primary to-primary-light text-white text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Link to="/schedule" className="bg-white text-primary px-6 lg:px-8 py-3 lg:py-4 rounded-lg text-base lg:text-lg font-semibold hover:bg-gray-100 transition-colors w-full sm:w-auto">
              View Class Schedule
            </Link>
          </div>
        </motion.div>
